...
/*https://github.com/DevsOnFlutter/file_manager/blob/main/README.md */
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: () async {
          // Navigate to landingPage when back button is pressed
      ...
      builder: (BuildContext context) {
        ...
        return Dialog(
          child: Container(
            ...
            decoration: const BoxDecoration(color: Color(0xfff6350ff)),
                ...
                ListTile(
                  title: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'New Name',
                      hintStyle: TextStyle(
                        color: const Color.fromARGB(218, 241, 241, 241)
                            .withOpacity(0.19),
                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        var parentDirectory = entity.parent;
                        // Construct the new path
                        var newPath =
                            '${parentDirectory.path}/${folderCreate.text}';
                    ...
                    ElevatedButton(
                      onPressed: () {
                        // Close the dialog without renaming on cancel
                        Navigator.pop(context);
                      },
